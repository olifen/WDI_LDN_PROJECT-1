document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function shuffle() {
    var flagIndex = flagsHard.length;
    var index;
    var temp;
    ...
    while (flagIndex > 0) {
      ...
      flagIndex--;
      temp = flagsHard[flagIndex];
      flagsHard[flagIndex] = flagsHard[index];
      flagsHard[index] = temp;
    }
  }
...
// deals 4 cards into each player's board
  function deal() {
    for(var i=0; i<=3; i++) {
      player1Flags.push(flagsHard.pop());
      player2Flags.push(flagsHard.pop());
    }
  }
  ...
  function setBoard() {
    ...
    pileFlags[0].src = flagsHard[0].image;
    pileFlags[1].src = flagsHard[1].image;
  }
